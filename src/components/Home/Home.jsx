            ...
            <div className='mt-10 container mx-auto'>
                ...
                <div className='flex items-center justify-between '>
                    <div className='w-2/4 ms-24'>
                        ...
                        <button class="inline-block cursor-pointer rounded-md bg-gray-800 px-4 py-3 text-center font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-gray-900 mt-3">Get Started</button>
