            ...
            <div className='mt-10 container mx-auto'>
                ...
                <div className='md:flex items-center justify-between '>
                    <div className='w-2/4 ms-2 md:ms-24'>
                        ...
                        <p className='mt-5 mb-5 md:mt-10 text-gray-600'>Explore thousands of job opportunities with all the <br /> information you need. Its your future. Come find it. Manage all <br /> your job application from start to finish.</p>
